...
void setup(){
  ...
  arduino_port = new Serial(this, "/dev/cu.usbmodem14101", 9600);
...
synchronized void packetEvent(CarnivorePacket packet){
  if(isOnline) {
    ...
    println("packet: " + packet.senderPort + " " + packet.receiverPort);
...
color port2color(int port) {
  ...
  //if(port == 515)   { return color8  ; }   //printer spooler
  ...
  if(port == 50)  { return color5  ; }   //re-mail-ck
  if(port == 109)  { return color5  ; }   //pop2
  if(port == 110)  { return color5  ; }   //pop3
  if(port == 143)  { return color5  ; }    //imap
  if(port == 465)  { return color5  ; }    //ssmtp
  if(port == 993)  { return color5  ; }    //imap
  if(port == 995)  { return color5  ; }    //ssmtp
  if(port == 1900)  { return color5  ; }    //ssmtp
  if(port == 2197)  { return color5  ; }    //ssmtp
  ...
  //if(port == 5190) { return color6  ; }   //ichat
  //if(port == 5353) { return color6  ; }   //ichat
  if(port == 443) { return color6  ; }   //ichat
  if(port == 5223) { return color6  ; }   //ichat
  if(port == 137) { return color6  ; }   //ichat
  if(port == 138) { return color6  ; }   //ichat
